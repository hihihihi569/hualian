<template>
  <div id="detailCotraner" class="slider-enter-active">
    <Header title='影片详情'>
  ...
  mounted () {
    this.axios.get('/api/detailmovie?movieId=' + this.movieId).then(res => {
      ...
      if (msg === 'ok') {
        ...
        this.$nextTick(() => {
          this.swiper = new window.Swiper(this.$refs.detail_player, {
            slidesPerView: 'auto',
            freeMode: true,
            freeModeSticky: true
          })
...
<style scoped>
#detailCotraner{ position: absolute;left: 0;top: 0;z-index: 100;width: 100%; min-height: 100%;background: #fff}
#detailCotraner .slider-enter-active {animation: 0.3s slideMove;}
@keyframes slideMove {
  0% {
